...
public class LoginFormBean extends AbstractFormBean implements IRequest, IResponse {
    ...
    LoginHeaderBean loginHeaderBean = new LoginHeaderBean();
    ...
    public LoginHeaderBean getLoginHeaderBean() {
        return loginHeaderBean;
    }

    public void setLoginHeaderBean(LoginHeaderBean loginHeaderBean) {
        this.loginHeaderBean = loginHeaderBean;
    }
