...
public class CusMessagingHistoryListLazySorter implements Comparator<CusMessagingHistoryListLineBean> {
    ...
    public CusMessagingHistoryListLazySorter(String sortField, SortOrder sortOrder) {
        this.sortOrder = sortOrder;
        this.sortField = sortField;
    }

    public int compare(CusMessagingHistoryListLineBean member1, CusMessagingHistoryListLineBean member2) {
        ...
        try {
            ...
            applicationLogger.log("Item Info List Sorter Process finished.", LogLevel.INFO);
