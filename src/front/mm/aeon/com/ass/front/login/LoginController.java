...
import mm.aeon.com.ass.front.common.VCSMPasswordEncoder;
...
public class LoginController extends AbstractASSController
    ...
    public LoginFormBean process(LoginFormBean loginFormBean) {
        ...
        try {
            ...
            loginInfoReferReq.setPassword(VCSMPasswordEncoder.base64Encode(loginFormBean.getLoginInfo().getPassword()));
            ...
            if (loginInfoReferRes != null) {
                ...
                loginFormBean.getLoginUserInfo().setAgentId(loginInfoReferRes.getAgentId());
                loginFormBean.getLoginUserInfo().setAgentLevel(loginInfoReferRes.getAgentName().toUpperCase());
                loginFormBean.getLoginUserInfo().setTimeInterval(loginInfoReferRes.getTimeInterval());
                loginFormBean.getLoginUserInfo().setAgentCode(loginInfoReferRes.getAgentLevelCode());
                loginFormBean.getLoginUserInfo().setLoggedIn(true);
                loginFormBean.getLoginUserInfo().setAtAgentLevelTypeName(loginInfoReferRes.getAtAgentLevelTypeName());
                MDC.put("UserID", loginFormBean.getLoginUserInfo().getAgentId());
